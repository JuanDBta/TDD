...
**[TDD PROJECT]**  In this project we implemented a class with some methods, but we did it by doing test-driven development (TDD). The idea is to write tests first and then the code.
...
- **[Added Fizzbuzz method]**
- **[Added spec folder to store tests]**
...
- [Coming Soon...](https://github.com/JuanDBta/TDD)
...
```sh
  cd my-folder
  git clone "https://github.com/JuanDBta/TDD.git"
```
### Run

Go to your /TDD folder:
...
You can deploy this project using:<br>[Coming Soon!!!](https://github.com/JuanDBta/TDD)
